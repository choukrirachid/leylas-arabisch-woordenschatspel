...
const dutchForms: Record<string, [string, string?, string?, string?]> = {
  ...
  bread: ["brood", "het brood", "broden", "de broden"],
  date: ["dadel", "de dadel", "dadels", "de dadels"],
  fridge: ["een koelkast", "de koelkast", "koelkasten", "de koelkasten"],
  milk: ["melk", "de melk", "melken", "de melken"],
  water: ["water", "het water", "wateren", "de wateren"],
  garden: ["een tuin", "de tuin", "tuinen", "de tuinen"],
  tree: ["een boom", "de boom", "bomen", "de bomen"],
  flower: ["bloem", "de bloem", "bloemen", "de bloemen"],
...
const dualForms: Record<string, [string, string, string]> = {
  ...
  bread: ["خُبْزَانِ", "خُبْزَيْنِ", "twee broden"],
  ...
  flower: ["وَرْدَتَانِ", "وَرْدَتَيْنِ", "twee bloemen"],
...
const nouns: VocabularyItem[] = [
  ...
  noun(["bread", "brood", "broden", "food", "mudhakkar", "خُبْزٌ", "الْخُبْزُ", "أَخْبَازٌ", "الْأَخْبَازُ", "خُبْزٍ", "الْخُبْزِ", "أَخْبَازٍ", "الْأَخْبَازِ"]),
  noun(["date", "dadel", "dadels", "food", "mudhakkar", "تَمْرٌ", "التَّمْرُ", "تُمُورٌ", "التُّمُورُ", "تَمْرٍ", "التَّمْرِ", "تُمُورٍ", "التُّمُورِ"]),
  ...
  noun(["milk", "melk", "melken", "food", "mudhakkar", "حَلِيبٌ", "الْحَلِيبُ", "أَحْلِبَةٌ", "الْأَحْلِبَةُ", "حَلِيبٍ", "الْحَلِيبِ", "أَحْلِبَةٍ", "الْأَحْلِبَةِ"]),
  noun(["water", "water", "wateren", "food", "mudhakkar", "مَاءٌ", "الْمَاءُ", "مِيَاهٌ", "الْمِيَاهُ", "مَاءٍ", "الْمَاءِ", "مِيَاهٍ", "الْمِيَاهِ"]),
  ...
  noun(["flower", "bloem", "bloemen", "outside_transport", "muannath", "وَرْدَةٌ", "الْوَرْدَةُ", "وَرْدَاتٌ", "الْوَرْدَاتُ", "وَرْدَةٍ", "الْوَرْدَةِ", "وَرْدَاتٍ", "الْوَرْدَاتِ"]),
