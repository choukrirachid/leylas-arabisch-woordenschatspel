...
const modeLabels: Record<Exclude<Mode, "home">, { title: string; subtitle: string }> = {
  ...
  jar: { title: "Fī, ʿalā en majrūr", subtitle: "Na فِي en عَلَى volgt een اِسْم مَجْرُور." },
  zarf: { title: "Boven, onder, naast...", subtitle: "Oefen ظَرْف مَكَان met bekende woorden." },
  ishara: { title: "Hādhā / hādhihi", subtitle: "Kies هَٰذَا of هَٰذِهِ." },
